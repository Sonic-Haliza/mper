...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                hisoka.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/adccd6cb8da8d5385560e.jpg' }, caption: `*Hai Kak ${m.pushName}*\n\n Bot Rental Prices\n⭔ 13k Per Group via Dana 1 Minggu\n⭔ 18k via pulsa 1 minggu\n\n Premium Price Bot\n⭔ 8k per User 1 minggu\n\n\nFor more details, you can chat with the owner\nhttps://wa.me/6282211991425 (Owner)\n\nDonate For Me : \n\n⭔ 
               Dana/Pulsa: 082211991425\nMake doang donasi kagak, hehe canda bro` }, { quoted: m })
            }
            break
            case 'sc': {
